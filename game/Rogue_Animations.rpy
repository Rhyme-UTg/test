...
label Display_Background(Entry = 0): #rkelj 
...
label Rogue_Middle_Launch(T = Trigger):    
    call Rogue_Hide
    $ Trigger = T
    show Rogue_Sprite at SpriteLoc(RogueX.SpriteLoc) zorder RogueX.Layer:
...
image PhoneScreen:
    ...
    contains:
        ...
        ConditionSwitch(      
            ...
            "Ch_Focus.Loc == 'bg bg_jean'", "bg_jean",
...
label Close_Launch(GirlA=0,GirlB=0,XLoc=0,YLoc=0,XZoom=0):  #rkelj  
    ...
    while BO:         
            ...
            if BO[0] == RogueX:   
                    ...
                    call Jean_Hide  
                    show Jean_Sprite at SpriteLoc(XLoc,YLoc) zorder JeanX.Layer:
                            alpha 1
                            zoom 1
                            xzoom XZoom
                            yzoom 1.3
...
label Les_Launch(Girl=0,XLoc=0,YLoc=0,XZoom=0,BO=[]): #rkelj   
