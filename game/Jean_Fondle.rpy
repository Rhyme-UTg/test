...
label Jean_Fondle_Breasts:
    ...
    if "no fondle breasts" in JeanX.DailyActions:               
        $ Tempmod -= 5 
        $ Tempmod -= 10 if "no fondle breasts" in JeanX.RecentActions else 0        
        
    $ Approval = ApprovalCheck(JeanX, 950, TabM = 3) # 95, 110, 125 -120(215)
    ...
    if "fondle breasts" in JeanX.RecentActions:
        $ JeanX.FaceChange("sexy", 1)
        ch_j "Mmmm, again? I guess. . ."
        jump Jean_FB_Prep
    elif "fondle breasts" in JeanX.DailyActions:
        $ JeanX.FaceChange("sexy", 1)
    ...
    if Approval >= 2:             
        ...
        if "no fondle breasts" in JeanX.RecentActions:  
            ch_j "I'm not used to repeating myself."
        elif JeanX.Taboo and "tabno" in JeanX.DailyActions and "no fondle breasts" in JeanX.DailyActions:  
            ch_j "I've had enough of this today." 
        elif "no fondle breasts" in JeanX.DailyActions:       
            ch_j "Don't ask me again today."
        elif JeanX.Taboo and "tabno" in JeanX.DailyActions:  
            ch_j "I told you. . . not here, [JeanX.Petname]."  
        elif not JeanX.FondleB:
            $ JeanX.FaceChange("bemused")
            ch_j "Look, don't touch, [JeanX.Petname]. . ."
        else:
            $ JeanX.FaceChange("bemused")
            ch_j "Yeah, you wish."   
        menu:
            extend ""
            "Sorry, never mind." if "no fondle breasts" in JeanX.DailyActions:
                $ JeanX.FaceChange("bemused")
                ch_j "It's fine, I get it."              
                return
            "Maybe later?" if "no fondle breasts" not in JeanX.DailyActions:
                $ JeanX.FaceChange("sexy")  
                ch_j ". . . I guess? Maybe."
                ...
                $ JeanX.RecentActions.append("no fondle breasts")                      
                $ JeanX.DailyActions.append("no fondle breasts")            
                return                
            "Come on, Please?":             
                if Approval:
                    $ JeanX.FaceChange("sexy")     
            ...
            "[[Grab her chest anyway]":                                               # Pressured into fondling. 
                $ Approval = ApprovalCheck(JeanX, 350, "OI", TabM = 3) # 35, 50, 65
...
label Jean_FB_Prep: #Animation set-up 
    if Trigger == "kiss you": 
    ...
    call Jean_Breasts_Launch("fondle breasts")
    
    if Situation == JeanX:                                                                  
            #Jean auto-starts    
            $ Situation = 0
            if (JeanX.Over or JeanX.Chest) and not JeanX.Uptop:
                ...
                if ApprovalCheck(JeanX, 1250, TabM = 1) or (JeanX.SeenChest and ApprovalCheck(JeanX, 500) and not JeanX.Taboo):
                        $ JeanX.Uptop = 1
                        $ Line = JeanX.Over if JeanX.Over else JeanX.Chest
    ...
    $ JeanX.DrainWord("no fondle breasts")
    $ JeanX.RecentActions.append("fondle breasts")                      
    $ JeanX.DailyActions.append("fondle breasts") 
    call Jean_Breasts_Launch("fondle breasts")
    
label Jean_FB_Cycle: #Repeating strokes
    while Round >=0:  
        $ Trigger = "fondle breasts"
        call Shift_Focus(JeanX) 
        $ JeanX.LustFace()    
        ...
        if Player.Focus >= 100 or JeanX.Lust >= 100: 
                    ...
                    if Line == "came": #ex Player.Focus <= 20: 
                            ...
                            if "unsatisfied" in JeanX.RecentActions and JeanX.SEXP >= 20:#And Jean is unsatisfied,  
        ...
        if JeanX.SEXP >= 100 or ApprovalCheck(JeanX, 1200, "LO"):
            pass
        elif Cnt == (5 + JeanX.FondleB):
                    $ JeanX.Brows = "confused"
                    ch_j "Having fun there?" 
        elif JeanX.Lust >= 85:
                    pass  
        elif Cnt == (15 + JeanX.FondleB) and JeanX.SEXP >= 15 and not ApprovalCheck(JeanX, 1500):
                    $ JeanX.Brows = "confused" 
                    menu:
                        ch_j "Maybe it's time for something else, [JeanX.Petname]?"
                        "Finish up.":
                                "You let go. . ."   
                                jump Jean_FB_After
        ...
        if JeanX.Lust >= 50 and not JeanX.Uptop and (JeanX.Chest or JeanX.Over):
                $ JeanX.Uptop = 1
...
label Jean_Suck_Breasts:
    ...
    if JeanX.SuckB: #You've done it before
        $ Tempmod += 15
    if not JeanX.Chest and not JeanX.Over:
        $ Tempmod += 15
    if JeanX.Lust > 75: #She's really horny
        $ Tempmod += 20
    ...
    if "no suck breasts" in JeanX.DailyActions:               
        $ Tempmod -= 5 
        $ Tempmod -= 10 if "no suck breasts" in JeanX.RecentActions else 0   
        
    $ Approval = ApprovalCheck(JeanX, 1050, TabM = 4) # 105, 120, 135, Taboo -160(265)
    ...
    if "suck breasts" in JeanX.RecentActions:
        $ JeanX.FaceChange("sexy", 1)
        ch_j "Mmmm, again? I guess. . ."
        jump Jean_SB_Prep
    elif "suck breasts" in JeanX.DailyActions:
        $ JeanX.FaceChange("sexy", 1)
        $ Line = renpy.random.choice(["You didn't get enough earlier?",
            "Chill. . .",
            "Mmm. . ."]) 
    ...
    if Approval >= 2:                                                                   #She's into it. . .
        ...
        $ JeanX.FaceChange("angry", 1)
        if "no suck breasts" in JeanX.RecentActions:  
            ch_j "I'm not used to repeating myself."
        elif JeanX.Taboo and "tabno" in JeanX.DailyActions and "no suck breasts" in JeanX.DailyActions:  
            ch_j "I told you, I'm not comfortable in public." 
        elif "no suck breasts" in JeanX.DailyActions:       
            ch_j "Don't ask me again today."
        elif JeanX.Taboo and "tabno" in JeanX.DailyActions:  
            ch_j "I told you. . . not here, [JeanX.Petname]."  
        elif not JeanX.SuckB:
            $ JeanX.FaceChange("bemused")
        ...
        menu:
            extend ""
            "Sorry, never mind." if "no suck breasts" in JeanX.DailyActions:
                $ JeanX.FaceChange("bemused")
                ch_j "It's fine, I get it."              
                return
            "Maybe later?" if "no suck breasts" not in JeanX.DailyActions:
                $ JeanX.FaceChange("sexy")  
                ch_j ". . . I guess? Maybe."
                $ JeanX.Statup("Love", 80, 1)
                $ JeanX.Statup("Love", 50, 1)
                ...
                if JeanX.Taboo:                    
                    $ JeanX.RecentActions.append("tabno")                      
                    $ JeanX.DailyActions.append("tabno") 
                $ JeanX.RecentActions.append("no suck breasts")                      
                $ JeanX.DailyActions.append("no suck breasts")            
                return
            "Come on, Please?":             
                if Approval:
                    $ JeanX.FaceChange("sexy")     
            ...
            "[[Start sucking anyway]":                                               # Pressured into licking. 
                $ Approval = ApprovalCheck(JeanX, 450, "OI", TabM = 3) # 45, 60, 75, -120(165)
                if Approval > 1 or (Approval and JeanX.Forced):
                    $ JeanX.FaceChange("sad")
                    $ JeanX.Statup("Love", 70, -5, 1)
                    $ JeanX.Statup("Love", 20, -2, 1)                 
...
label Jean_SB_Prep:                                                                 #Animation set-up 
            
    if Trigger2 == "suck breasts":
        return
             
    call Jean_Breasts_Launch("suck breasts")
    ...
    if Situation == JeanX:                                                        
            ...
            menu:
                ...
                "Praise her.":       
                    $ JeanX.FaceChange("sexy", 1)                    
                    $ JeanX.Statup("Inbt", 80, 3) 
                    ch_p "Mmm, I like this, [JeanX.Pet]."
                    $ JeanX.NameCheck() #checks reaction to petname
                    "You start to fondle it."
                    $ JeanX.Statup("Love", 85, 1)
                    $ JeanX.Statup("Obed", 90, 1)
    ...
    if JeanX.Taboo:
        $ JeanX.DrainWord("tabno")
    $ JeanX.DrainWord("no suck breasts")
    $ JeanX.RecentActions.append("suck breasts")                      
    $ JeanX.DailyActions.append("suck breasts") 
    call Jean_Breasts_Launch("suck breasts")
    
label Jean_SB_Cycle: #Repeating strokes  
    if Trigger2 == "kiss you":
            $ Trigger2 = 0
    while Round >=0:  
        $ Trigger = "suck breasts"
        call Shift_Focus(JeanX) 
        $ JeanX.LustFace()    
        ...
        if JeanX.SEXP >= 100 or ApprovalCheck(JeanX, 1200, "LO"):
            pass
        elif Cnt == (5 + JeanX.SuckB):
                    $ JeanX.Brows = "sly"
                    ch_j "This is kinda nice. . ."   
        elif JeanX.Lust >= 85:
                    pass
        elif Cnt == (15 + JeanX.SuckB) and JeanX.SEXP >= 15 and not ApprovalCheck(JeanX, 1500):
                    $ JeanX.Brows = "confused"        
                    menu:
...
label Jean_Fondle_Thighs:
    ...
    if JeanX.FondleT: #You've done it before
        $ Tempmod += 10
    ...
    if "no fondle thighs" in JeanX.DailyActions:               
        $ Tempmod -= 5 
        $ Tempmod -= 10 if "no fondle thighs" in JeanX.RecentActions else 0   
            
    $ Approval = ApprovalCheck(JeanX, 750, TabM=1) # 75, 90, 105, Taboo -40(105)
    ...
    if Situation == "auto":                                                                  #You auto-start
        if Approval:
            ...
            $ JeanX.FaceChange("surprised")
            $ JeanX.Statup("Obed", 50, -2)
            ch_j "Keep it above the waist, [JeanX.Petname]."               
            $ Tempmod = 0
            $ Trigger2 = 0
            return
    ...
    if Situation == "pullback":     
        ...
        jump Jean_FT_Prep  
    elif "fondle thighs" in JeanX.RecentActions:
        $ JeanX.FaceChange("sexy", 1)
        ch_j "Mmmm, again? I guess. . ."
        jump Jean_FT_Prep
    elif "fondle thighs" in JeanX.DailyActions:
        $ JeanX.FaceChange("sexy", 1)       
    ...
    if Approval >= 2:                                                                   #She's into it. . .
        ...
        if JeanX.Forced:
            ...
            $ JeanX.Statup("Obed", 90, 1)
            $ JeanX.Statup("Inbt", 60, 1)
        ch_j "Ok [JeanX.Petname], go ahead."   
        $ JeanX.Statup("Love", 90, 1)
        $ JeanX.Statup("Inbt", 50, 3) 
        jump Jean_FT_Prep   
        ...
        $ JeanX.FaceChange("angry", 1)
        if "no fondle thighs" in JeanX.RecentActions:  
            ch_j "I'm not used to repeating myself."
        elif JeanX.Taboo and "tabno" in JeanX.DailyActions and "no fondle thighs" in JeanX.DailyActions:  
            ch_j "I told you not to touch me like that in public!" 
        elif "no fondle thighs" in JeanX.DailyActions:       
            ch_j "Don't ask me again today."
        elif JeanX.Taboo and "tabno" in JeanX.DailyActions:  
            ch_j "I told you. . . not here, [JeanX.Petname]."  
        elif not JeanX.FondleT:
            $ JeanX.FaceChange("bemused")
            ch_j "Look, don't touch, [JeanX.Petname]."
        else:
            $ JeanX.FaceChange("bemused")
        ...
        menu:
            extend ""
            "Sorry, never mind." if "no fondle thighs" in JeanX.DailyActions:
                $ JeanX.FaceChange("bemused")
                ch_j "It's fine, I get it."             
                return
            "Maybe later?" if "no fondle thighs" not in JeanX.DailyActions:
                $ JeanX.FaceChange("sexy")  
                ch_j ". . . I guess? Maybe."
                $ JeanX.Statup("Love", 80, 1)
                $ JeanX.Statup("Inbt", 30, 2)    
                if JeanX.Taboo:                    
                    $ JeanX.RecentActions.append("tabno")                      
                    $ JeanX.DailyActions.append("tabno") 
                $ JeanX.RecentActions.append("no fondle thighs")                      
                $ JeanX.DailyActions.append("no fondle thighs")            
                return
            "Come on, Please?":             
                if Approval:
                    $ JeanX.FaceChange("sexy")     
            ...
            "[[Start caressing her thigh anyway]":                                               # Pressured into fondling. 
                $ Approval = ApprovalCheck(JeanX, 350, "OI", TabM = 2) # 35, 50, 65, -80(105)
                if Approval > 1 or (Approval and JeanX.Forced):
                    $ JeanX.FaceChange("sad")
                    $ JeanX.Statup("Love", 70, -5, 1)
                    $ JeanX.Statup("Love", 20, -2, 1)                 
...
label Jean_FT_Prep:                                                                 #Animation set-up 
    if Trigger == "kiss you": 
    ...
    $ Tempmod = 0    
    call Jean_Pussy_Launch("fondle thighs")
    if not JeanX.FondleT:        
        if JeanX.Forced:
            $ JeanX.Statup("Love", 90, -10)
    ...
    if JeanX.Taboo:               
        $ JeanX.Statup("Lust", 200, (int(Taboo/5)))                               
        $ JeanX.Statup("Inbt", 200, (2*(int(Taboo/5))))
    ...
    if JeanX.Taboo:
        $ JeanX.DrainWord("tabno")
    $ JeanX.DrainWord("no fondle thighs")
    $ JeanX.RecentActions.append("fondle thighs")                      
    $ JeanX.DailyActions.append("fondle thighs")  
    call Jean_Pussy_Launch("fondle thighs")
    
label Jean_FT_Cycle:                                                                #Repeating strokes
    while Round >=0:  
        $ Trigger = "fondle thighs"
        call Shift_Focus(JeanX) 
        $ JeanX.LustFace()    
        ...
        if JeanX.SEXP >= 100 or ApprovalCheck(JeanX, 1200, "LO"):
            pass
        elif Cnt == (5 + JeanX.FondleT):
                    $ JeanX.Brows = "confused"
                    ch_j "Kinda nice, but. . ."   
        elif Cnt == (15 + JeanX.FondleT) and JeanX.SEXP >= 15 and not ApprovalCheck(JeanX, 1500):
                    $ JeanX.Brows = "confused"        
                    menu:
                        ch_j "Maybe try something else?"                         
                        "Finish up.":
...
label Jean_Fondle_Pussy:
    ...
    if "no fondle pussy" in JeanX.DailyActions:               
        $ Tempmod -= 5 
        $ Tempmod -= 10 if "no fondle pussy" in JeanX.RecentActions else 0   
...
label Jean_Lick_Pussy: 
    ...
    if "no lick pussy" in JeanX.DailyActions:               
        $ Tempmod -= 5 
        $ Tempmod -= 10 if "no lick pussy" in JeanX.RecentActions else 0   
...
label Jean_Fondle_Ass: 
    ...
    if "no fondle ass" in JeanX.DailyActions:               
        $ Tempmod -= 5 
        $ Tempmod -= 10 if "no fondle ass" in JeanX.RecentActions else 0   
...
label Jean_Insert_Ass:
    ...
    if "no insert ass" in JeanX.DailyActions:               
        $ Tempmod -= 5 
        $ Tempmod -= 10 if "no insert ass" in JeanX.RecentActions else 0   
...
label Jean_Lick_Ass: 
    ...
    if "no lick ass" in JeanX.DailyActions:               
        $ Tempmod -= 5 
        $ Tempmod -= 10 if "no lick ass" in JeanX.RecentActions else 0   
