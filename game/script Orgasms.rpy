    ...
    menu:
        ...
        "Cum Outside":
            menu:
                ...
                "Cum on her belly" if Girl != RogueX and (Trigger == "sex" or Trigger == "anal" or Trigger == "hotdog" or Trigger == "foot" or Trigger == "psy"):
                        jump Girl_Cum_Outside
        ...
        "Pull back" if Trigger != "psy" and Girl.Loc == bg_current:
...
#                call expression Girl.Tag + "_Kissing_Launch" pass (Trigger)
    ...
    if Situation == "auto" or Situation == "warn":
                ...
                if "full" in Girl.RecentActions:
                        ...
                        if Girl == RogueX:
                                ...
                                ch_j "Whoa, give me some warning there." 
                        $ Girl.FaceChange()
    ...
    if renpy.showing(Girl.Tag+"_PJ_Animation"): #if renpy.showing("Rogue_PJ_Animation"):                 
                call expression Girl.Tag + "_Kissing_Launch" pass (Trigger)
    elif renpy.showing(Girl.Tag+"_Doggy") or renpy.showing(Girl.Tag+"_SexSprite"): #if renpy.showing("Rogue_Doggy"):
            call expression Girl.Tag+"_HJ_Launch" pass ("cum")
    ...
    if "full" in Girl.RecentActions:
            ...
            if ApprovalCheck(Girl, 900):
                ...
                if Girl == RogueX:
                        ...
                        ch_j "I guess I could get used to that. . ." 
                $ Girl.Spunk.remove("mouth")
                jump Girl_Swallowed
    ...
    if Girl == RogueX:
            ...
            if "full" in Girl.RecentActions:
                    ch_j "I'm a bit full, [Girl.Petname]. . ." 
            else:
                    ch_j "As if. . ."
    menu:
        extend ""
...
label Girl_Creampie_A:                             
        ...
        if ApprovalCheck(Girl, 1200) or Girl.CreamP:        
                ...
                if Girl == RogueX:
                        ...
                        ch_l "Thanks for warning me *grunt* [Girl.Petname], but I don't think so."
                elif Girl == JeanX:
                        ch_j "Yeah, let's not, time to pull out."
        jump Girl_Cum_Outside
...
label Girl_Cum_Outside: 
        ...
        if Trigger != "foot":
            if Girl == RogueX: #fix, change this once more poses are available
                ...
                #remove when she has a sex pose. . .
                pass
            else:
...
label Girl_Cleanup(Girl=0,Choice = "random",Options=[],Cnt=0,Cleaned=0,Original=0): 
    if Girl not in TotalGirls or "painted" in Girl.RecentActions: #should remove "character don't exist" errors
            return          
    if Choice == "after":
                        ...
                        if not Cnt:
                            ...
                            if ApprovalCheck(Girl, 300, "I") or ApprovalCheck(Girl, 1000):
                                    ...
                                    if Girl == RogueX:
                                            ...
                                            ch_j "Not in the mood, [Girl.Petname]."
