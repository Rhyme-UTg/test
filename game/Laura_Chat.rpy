...
label Laura_About(Check=0): #rkelj 
...
#                    ch_l "Like I said, it's too late for that."
    ...
    if Line == "no":                                                                    
            ...
            if LauraX.Loc == "bg classroom":
                    ...
                    jump Campus
            elif LauraX.Loc in PersonalRooms: 
                    ch_j "Yeah, see you."
    ...
    menu Laura_Clothes_Under:   
        ...
        "Panties":
            menu:
                ...
                "Why don't you wear the black panties instead?" if LauraX.Panties and LauraX.Panties != "black panties":
