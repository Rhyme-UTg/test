...
label Jean_Handjob:
    ...
    if "no hand" in JeanX.DailyActions:               
        $ Tempmod -= 5 
        $ Tempmod -= 10 if "no hand" in JeanX.RecentActions else 0    
...
label Jean_Titjob:
    ...
    if "no titjob" in JeanX.DailyActions:               
        $ Tempmod -= 5 
        $ Tempmod -= 10 if "no titjob" in JeanX.RecentActions else 0    
    ...
    if not JeanX.Tit and Approval:                                                 #First time dialog    
        if JeanX.Forced: 
            ...
            $ JeanX.Brows = "sad"
            $ JeanX.Mouth = "smile" 
            ch_j "Well, maybe you deserve it."            
        elif JeanX.Obed >= (JeanX.Inbt - JeanX.IX):
            $ JeanX.FaceChange("normal")
            ch_j "If you'd like that. . ."              
    ...
    if Approval >= 2:                                                                   #She's into it. . .               
        ...
        if "no titjob" in JeanX.RecentActions:  
            ...
            ch_j "This is just way too exposed!"     
        elif "no titjob" in JeanX.DailyActions:       
            ...
            $ JeanX.FaceChange("bemused")
            ch_j "I'm not really into that, [JeanX.Petname]. . ."
        else:
            $ JeanX.FaceChange("bemused")
            ...
            "I think this could be fun for both of us. . .":             
                if Approval:
                    ...
                    if Approval >= 2 and JeanX.Blow:       
                        ...
                        ch_j "I could maybe blow you?"
                        menu:
                            ch_j "How about that [[blowjob]?"
                            "Ok, get down there.":
                                $ JeanX.Statup("Love", 80, 2)  
                                $ JeanX.Statup("Inbt", 60, 1)                                
                                $ JeanX.Statup("Obed", 50, 1) 
    ...
    if "no titjob" in JeanX.DailyActions:
        $ JeanX.FaceChange("angry", 1)
        ch_j "Look, I already told you no."   
        $ JeanX.RecentActions.append("angry")
        $ JeanX.DailyActions.append("angry")   
    elif JeanX.Forced:
        $ JeanX.FaceChange("angry", 1)
        ...
        $ JeanX.FaceChange("angry", 1)          
        $ JeanX.DailyActions.append("tabno") 
        ch_j "You really expect me to do that here? This isn't exactly \"covert.\""
        $ JeanX.Statup("Lust", 200, 5)  
        $ JeanX.Statup("Obed", 50, -3)  
    elif JeanX.Tit:
        $ JeanX.FaceChange("sad") 
...
label Jean_TJ_Cycle: #Repeating strokes  
    while Round >=0:  
        ...
        if JeanX.SEXP >= 100 or ApprovalCheck(JeanX, 1200, "LO"):
                ...
                $ JeanX.Brows = "confused"
                ch_j "Are you getting close here? I'm getting bored."        
        if Cnt == (10 + JeanX.Tit):
                $ JeanX.Brows = "angry"        
                menu:
                    ch_j "Seriously, can we do something else?"
                    "How about a BJ?" if JeanX.Action and MultiAction:
                        $ Situation = "shift"
                        call Jean_TJ_After
                        call Jean_Blowjob 
...
label Jean_TJ_After:    
    ...
    if JeanX.Tit > 5:
        ...
        if JeanX.Love >= 500:
            ...
            $ JeanX.Mouth = "sad"
            ch_j "Well I hope you got something out of that."        
    elif JeanX.Tit == 5:
            ch_j "You seem to enjoy that."   
...
label Jean_Blowjob:
    ...
    if "no blow" in JeanX.DailyActions:               
        $ Tempmod -= 5 
        $ Tempmod -= 10 if "no blow" in JeanX.RecentActions else 0    
    ...
    if not JeanX.Blow and "no blow" not in JeanX.RecentActions:        
        ...
        $ JeanX.Mouth = "kiss"
        ch_j "You want me to suck your cock?"
        if JeanX.Hand:          
            $ JeanX.Mouth = "smile"
            ch_j "Handjobs not enough now?"        
        $ JeanX.Blush = 1
    ...
    if not JeanX.Blow and Approval:                                                 #First time dialog        
        if JeanX.Forced: 
            ...
            $ JeanX.Brows = "sad"
            $ JeanX.Mouth = "smile" 
            ch_j "I have wondered how you taste."            
        elif JeanX.Obed >= (JeanX.Inbt - JeanX.IX):
            $ JeanX.FaceChange("normal")
            ch_j "If that's what you want. . ."               
        elif JeanX.Addict >= 50:
            $ JeanX.FaceChange("manic", 1)
            ch_j "[[wipes away a little drool]"   
        else: # Uninhibited 
            $ JeanX.FaceChange("sad")
            $ JeanX.Mouth = "smile"             
            ch_j "Huh. . ."       
    ...
    if Approval >= 2:                                                                   #She's into it. . .               
        ...
        if "no blow" in JeanX.RecentActions:  
            ...
            ch_j "Like I told you, not in public."  
        elif "no blow" in JeanX.DailyActions:       
            ch_j "Told you \"no,\" [JeanX.Petname]."
        elif JeanX.Taboo and "tabno" in JeanX.DailyActions:  
            ch_j "Like I told you, too public!"      
        elif not JeanX.Blow:
            $ JeanX.FaceChange("bemused")
            ch_j "I don't know if your taste will match your scent, [JeanX.Petname]. . ."
        else:
            $ JeanX.FaceChange("bemused")
            ...
            "Come on, please?":             
                if Approval:
                    ...
                    if ApprovalCheck(JeanX, 1100, TabM = 3): # 110, 125, 140, Taboo -120(230)             Handy instead?    
                        ...
                        $ JeanX.Arms = 1
                        if JeanX.Hand:
                            ch_j "Couldn't I just use my hand again?"
                            ch_j "You seemed to like that."
                        else:
                            ch_j "I could maybe use my hand instead, how's that sound?"
                        menu:
                            extend ""
                            "Sure, that's fine.":
                                $ JeanX.Statup("Love", 80, 2)  
        ...
        if Player.Focus < 100:                                                   
                    ...
                    menu:
                        ...
                        "Suck on it." if Speed != 3:
                                ...
                                if "Gwentro" not in JeanX.History: #calls the special Gwentro event
                                            call Gwentro
                                                    ...
                                                    menu:
                                                        "How about a handy?":
                                                                if JeanX.Action and MultiAction:
                                                                    ...
                                                                    ch_j "I need a break, can we wrap on this?"
#                                                        "How about a titjob?":
#                                                                if JeanX.Action and MultiAction:
#                                                                    $ Situation = "shift"
#                                                                    call Jean_BJ_After
...
#                                                                    ch_j "I need a break, can we wrap on this?"                                        
        ...
        if JeanX.SEXP >= 100 or ApprovalCheck(JeanX, 1200, "LO"):
            pass
                ...
                $ JeanX.Brows = "angry"        
                menu:
                    ch_j "I'm getting kinda bored. Can we do something else?"
                    ...
                    $ JeanX.Brows = "confused"
                    ch_j "Are you getting close here? I'm bored."  
        #End Count check
...
label Jean_BJ_After:    
    ...
    if "Jean Jobber" in Achievements:
        ...
        $ JeanX.FaceChange("smile", 1)
        ch_j "Your flavor is intoxicating."      
        ...
        pass
            ...
            if JeanX.Love >= 500:
                $ JeanX.Mouth = "smile"
                ch_j "Hey, whaddaya know, that wasn't bad."
            elif Player.Focus <= 20:
                $ JeanX.Mouth = "sad"
                ch_j "I hope you enjoyed that."     
    elif JeanX.Blow == 5:
        ch_j "I'm really getting the hang of this. . . right?"
        menu:
            "[[nod]":
                $ JeanX.FaceChange("smile", 1)
...
label Jean_Dildo_Pussy:
    ...
    if "no dildo" in JeanX.DailyActions:               
        $ Tempmod -= 5 
        $ Tempmod -= 10 if "no dildo" in JeanX.RecentActions else 0       
    ...
    if Situation == JeanX:                                                                  #Jean auto-starts   
                if Approval > 2:                                                      # fix, add Jean auto stuff here
                    ...
                    $ Tempmod = 0                               # fix, add Jean auto stuff here
                    $ Trigger2 = 0
                return            
...
label Jean_DP_Prep: #Animation set-up 
    ...
    if not JeanX.Forced and Situation != "auto":
        $ Tempmod = 15 if JeanX.PantsNum() >= 6 else 0           
...
label Jean_DA_Prep: #Animation set-up 
    ...
    if not JeanX.Forced and Situation != "auto":
        $ Tempmod = 20 if JeanX.PantsNum() >= 6 else 0           
        call Bottoms_Off(JeanX)
        if "angry" in JeanX.RecentActions:
            return    
...
label Jean_Footjob:
    ...
    if "no foot" in JeanX.DailyActions:               
        $ Tempmod -= 5 
        $ Tempmod -= 10 if "no foot" in JeanX.RecentActions else 0    
    ...
    if not JeanX.Foot and Approval:                                                 #First time dialog        
        ...
        if JeanX.Forced: 
            ...
            ch_j "Um, I guess this is secure enough. . ."    
...
#            ch_j "[Line]"
    ...
    if Approval >= 2:                                                                   #She's into it. . .               
        ...
        if "no foot" in JeanX.RecentActions:  
            ch_j "You should listen better, [JeanX.Petname]."
    ...
    if "no foot" in JeanX.DailyActions:
        ...
        $ JeanX.FaceChange("angry", 1)
        ch_j "You understand that I have claws down there too. . ."
        $ JeanX.Statup("Lust", 200, 5)    
        if JeanX.Love > 300:
                $ JeanX.Statup("Love", 70, -2)
        $ JeanX.Statup("Obed", 50, -2)    
...
label Jean_FJ_Cycle:    
    while Round >=0:  
        ...
        if Cnt == 20:
                    $ JeanX.Brows = "angry"        
                    menu:
                        ch_j "Hmm, this is getting a bit boring."
                        "How about a BJ?" if JeanX.Action and MultiAction:
                                $ Situation = "shift"
                                call Jean_FJ_After
                                call Jean_Blowjob   
...
label Jean_FJ_After:
    ...
    if "Jeanpedi" in Achievements:
            ...
            $ JeanX.FaceChange("smile", 1)
            ch_j "I think I'm finally back into practice on this."
                                    ...
                                    menu:
                                        ...
                                        "Hand":
                                            if ApprovalCheck(JeanX, 1000):
                                                    ...
                                                    ch_j "I'd rather not."
                                        "Mouth [[not available yet] (locked)":
                                            pass
                                        "Tits [[not available yet] (locked)":
                                            pass
                                        "Pussy [[not available yet] (locked)":
                                            pass
                                        "Anal [[not available yet] (locked)":
                                            pass                                            
                        "Other options":
                                menu:   
                                    "I also want to fondle her breasts." if Trigger2 != "fondle breasts":
