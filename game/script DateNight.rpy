        ...
        menu:
            ...
            "And I was thinking of asking. . .": 
                        menu:
                            ...
                            "[JeanX.Name] along too." if Girl != JeanX:
                                        $ Count = Girl.LikeJean
...
label DateNight(Date_Bonus=[0,0],Play_Cost=0,Date_Cost=[0,0],BO=[]): #(nee Prime_Bonus=0,Second_Bonus=0,Play_Cost=0,Prime_Cost=0,Second_Cost=0,BO=[]):
    ...
    if "dinner" in Player.RecentActions or "movie" in Player.RecentActions:            
            pass        #if Jean picked
    else:
            #if Jean didn't pick
            if Party[0] == RogueX:
...
label Date_Paying(Activity="dinner", Total_Cost=0):  
    ...
    if Line == "you":
            ...
            if ApprovalCheck(JeanX, 900) and len(Party) < 2:
                    ...
                    $ JeanX.Statup("Obed", 80, 2)     
                    if bg_current != "bg movies" and "dinnersex" in JeanX.RecentActions:
