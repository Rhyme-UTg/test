...
label Jackin(Girl=0,Cnt=0,BO=[]): #rkelj 
        ...
        if "unseen" in Girl.RecentActions:
                ...
                if Girl.SEXP < 10 and Girl != JeanX:
...
label Girl_Tag(Girl=0,Forced = 0,Gloves=0): #rkelj 
...
# Massage / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / /
label Massage(Girl=0,Current=0,Past=0,MCount=0): #rkelj 
        $ Girl = GirlCheck(Girl)
        call Shift_Focus(Girl)
        $ Tempmod = 0    
        if "angry" in Girl.RecentActions:
...
label Massage_Prep(Girl=Ch_Focus,Current=0,Past=0,MCount=0): #rkelj 
...
label Group_Strip(Girl=0,Tempmod = Tempmod,TempmodP=[0,0],BO=[]): #rkelj 
...
label Girl_Stripping(Girl=0): #rkelj  
        ...
        if "keepdancing" not in Girl.RecentActions:  
                ...
                if Girl.Over and Girl.Chest and (Girl.Panties or Girl.Legs or Girl.HoseNum() >= 10):          
                    ...
                    if ApprovalCheck(Girl, 1200, TabM = 3) or (Girl.SeenPanties and ApprovalCheck(Girl, 900, TabM = 3) and not Girl.Taboo):
                            $ Girl.Statup("Lust", 50, 5)                
                            $ Girl.Statup("Obed", 50, 1)
                    ...
                    # Will she go topless?
                    if ApprovalCheck(Girl, 1250, TabM = 3) or (Girl.SeenChest and ApprovalCheck(Girl, 1100, TabM = 3) and not Girl.Taboo):
                            $ Girl.Statup("Lust", 60, 5) 
                            $ Line = Girl.Chest                
                            $ Girl.Chest = 0                     
                            if not Girl.SeenChest:
...
# Start Girl_Lesbian / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / /
label Les_Interupted(Girl=0,BO=[]): #rkelj   
        $ Girl = GirlCheck(Girl)
...
label LesScene(Girl=0,Bonus = 0,BO=[]): #rkelj 
        $ Girl = GirlCheck(Girl)
        call Shift_Focus(Girl)
...
label Les_Prep(Girl=Ch_Focus,BO=[]): #rkelj     
        #sets the scene up
        $ Line = 0
...
#Start Les_Response >  >  >  >  >  >  >  >  >  >  >  >  >  >  >  >  >  >  >  >  >  >  >  >  >
label Les_Response(Speaker=0,Subject=0, Step=1, B=0, B2=0, Tempmod=0, Result=0, Approval = 0): #rkelj 
