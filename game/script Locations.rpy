...
label Class_Room_Seating(Girls=[],GirlB=0,GirlLike=0,Line=0,D20=0,BO=[]): #rkelj 
...
label ShowPool(BO=[],Loc=0): #rkelj 
        ...
        while BO:  
                if BO[0].Loc == bg_current:
                            ...
                            if BO[0] == RogueX:
                                    show Rogue_Sprite at Pool_Bob(DLoc) zorder 50  #BO[0].Layer 
                            elif BO[0] == KittyX:
                                    show Kitty_Sprite at Pool_Bob(DLoc) zorder 50                            
                            elif BO[0] == EmmaX:
                                    show Emma_Sprite at Pool_Bob(DLoc) zorder 50 
                            elif BO[0] == LauraX: 
                                    show Laura_Sprite at Pool_Bob(DLoc) zorder 50
                            elif BO[0] == JeanX: 
                                    show Jean_Sprite at Pool_Bob(DLoc) zorder 50 
                $ BO.remove(BO[0])
...
label Showering(Occupants = [], StayCount=[] , Showered = 0, Line = 0, BO=[]): #rkelj 
    ...
    menu:
        ...
        "Plan Chi!" if Current_Time != "Night" and LauraX.Loc == bg_current:
                    if LauraX.Lvl >= 2 and ApprovalCheck(LauraX, 1500, TabM=1, Loc="No") and ApprovalCheck(LauraX, 750, "I"):   
                        ...
                        ch_l "Huh?"     
        "Plan Alpha!" if Current_Time != "Night" and JeanX.Loc == bg_current:
                    if ApprovalCheck(JeanX, 1500, TabM=1, Loc="No") and Player.Lvl >= 5:   
...
label Study_Room_Explore: #rkelj 
    $ Line = 0
    $ D20 = renpy.random.randint(1, 20)    
    menu:
...
label Girls_Room_Entry(Chr=0): #rkelj 
        #Set Chr somehow. . .
        ...
        if Round >= 10 and Chr.Loc == bg_current and "gonnafap" in Chr.DailyActions and D20 >= 5: 
                ...
                #End "if you enter without knocking"
                            ...
                            if (D20 >=19 and Chr.Lust >= 50) or (D20 >=15 and Chr.Lust >= 70) or (D20 >=10 and Chr.Lust >= 80):    
                                    ...
                                    if Chr == RogueX:
                                            ...
                                            ch_j "Hey [Chr.Petname], I was getting dressed."  
                ...
                if Chr.Loc != bg_current:
                        ...
                        if Chr == RogueX:
                                ...
                                ch_j "Hey [Chr.Petname], almost time for bed." 
