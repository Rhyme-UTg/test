label Sleepover(Line = 0,BO=[]): #rkelj 
...
label Morningwood_Check(Girls=[0,-3],D20=0): #rkelj                 
        ...
        if len(Party) >= 2 and Party[0] == JeanX:
                    # Temporary, this removes Jean from the activity until her BJ stuff is in           #fix, remove
                    $ Party.reverse() 
        ...
        if len(Party) >= 2:
                ...
                if Line == "other" and Party[0].GirlLikeCheck(Party[1]) >= 500 and Part[1] != JeanX: #fix, remove Jean part once she has BJ anim
...
label Sleepover_MorningWood: #rkelj 
...
## start Poly _Start//////////////////////////////////////////////////////////
label Poly_Start(Newbie=0,Round2=0,Asked=0): #rkelj 
...
## start Harem _Start//////////////////////////////////////////////////////////
label Harem_Start(Newbie=0,Round2=0): #rkelj    
        # This is called prior to any new girls being added to your dating structure
...
label Frisky_Study(Prime_Bonus=0,Second=0,Line=0,Second_Bonus=0): #rkelj 
            ...
            if not Line and len(Party) >= 2 and not Prime_Bonus:
                        ...
                        if Party[0] == KittyX:
                                ...
                                "She unzips you pants and pulls your dick out, stroking it slowly."  
                        elif False:#Party[0] == JeanX and D20 > 15:
...
label Girls_Caught(Girl=0,TotalCaught=0,Shame=0,Count=0,T_Pet=0,BO=[]): #rkelj 
    ...
    if Girl == RogueX:        
            ...
            show Jean_Sprite at SpriteLoc(StageRight) with ease
...
label Xavier_Plan(Girl=0): #rkelj     
    ...
    if Girl == RogueX:
            ...
            if (Girl == EmmaX and "Psi" in Player.Traits) or (Girl == JeanX and "Alpha" in Player.Traits):
                    ...
                    $ Girl.Statup("Obed", 50, 40)
                    $ Girl.Statup("Inbt", 70, 30)
                    $ Girl.Statup("Obed", 200, 30)
                    $ Girl.Statup("Inbt", 200, 10)  
            ch_e "Well, [Girl.Petname], what should we ask for?" 
    elif Girl == LauraX:
            $ LauraX.ArmPose = 2
...
label Girl_Caught_Changing(Girl=0): #rkelj 
        ...
        if D20 > 5: 
                ...
                if Girl == RogueX:
                        ...
                        ch_j "Oh, [JeanX.Petname]. Hoping to catch me dressing again?"
...
label Girl_Caught_Mastubating(Girl=0): #rkelj 
...
#start Call_For_Les / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / /              
label Call_For_Les(Girl=0,Girl2=0,BO=[]): #rkelj      
...
label Girls_Caught_Lesing(Girl=0,Girl2=0,BO=[]): #rkelj 
            ...
            menu:
                ...
                "Knock politely":
                        ...
                        if Girl == RogueX:
                                ...
                                ch_j "Hey [JeanX.Petname], we were just giving [Girl2.Name]'s tongue a workout."         
...
label Girl_Caught_Shower(Girl=0): #rkelj 
        if Girl not in TotalGirls:
                return
        call Shift_Focus(Girl)
        ...
        if Line == "knock":                                                                                         
                ...
                if "gonnafap" in Girl.DailyActions:                                    
                        ...
                        if Girl == RogueX: 
                                ...
                                ch_j "Oh, [JeanX.Petname]. I'm about done here."
                #end "knocked"
        else:                                                                                                       
            #You don't knock   
            if "gonnafap" in Girl.DailyActions:  
...
label Pool_Sunbathe(Girl=0,Type=0,Mod=0): #rkelj 
    ...
    if not Girl.Over and not Girl.Chest and not Girl.Legs and not Girl.Panties:
            ...
            if Girl == RogueX:
                    ...
                    ch_j "Seen's that's taken care of. . ."
    ...
    while True:
            ...
            if Girl.SeenCheck(1) and AloneCheck(): #makes it easier if you've already seen her
                    $ Mod -= 100
...
label Pool_Skinnydip(Girl=0,Line=0,Type=0,Mod=0): #rkelj 
    # This gets called with a character name, and checks 
    # Line tends to carry the current agreement state, Type tends to carry the item being discussed
    # mod is a modifier, base 0, but +200 if asking for no bottoms
...
# Start Pool Topless / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / /
label Pool_Topless(Girl=Ch_Focus,BO=[]): #rkelj   
...
label Breakup(Girl=0,Other=0,Anger = 0,BO=[]): #rkelj 
...
label Share(Girl=0,Other=0): #rkelj 
...
label Cheated(Girl=0,Other=0, Resolution = 0, B = 0): #rkelj 
        ...
        if Resolution >= 5 and Line == "threeway": #she agrees to a threeway
                    ...
                    if Girl.Cheated:     
                            ...
                            if Girl == RogueX:
                                    ...
                                    ch_j "I'm not givign you more chances to fuck this up."   
                    else:
                            $ Girl.Statup("Obed", 80, 30) 
                            if Girl == RogueX:
...
label NoFap(Girl=0,TabStore=Taboo,Cnt=0): #rkelj 
...
# Start Call to Fap / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / /  
label CalltoFap(Girl=0,Fap=0): #rkelj 
...
label PsychicFlash(Face="sly",TempLoc=0): #rkelj     
...
label MindFuck(TempLoc=0): #rkelj 
