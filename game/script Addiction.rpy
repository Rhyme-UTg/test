...
label First_Addicted(Girl=0): #rkelj 
...
label Addicted_Ultimatum(AddictStore=Girl.Addict): #rkelj 
            ...
            if Girl.Addict >= 80:
                    ...
                    if Count2 > 2:
                            ...
                            if Girl == RogueX:
                                    ...
                                    ch_j "Get serious here, [Girl.Petname]."
                            $ Tempmod += 10                  
...
label First_Addicted_End: #rkelj    
...
# Event Addiction_Fix /////////////////////////////////////////////////////  
label Addiction_Fix(Girl=0): #rkelj 
        $ Girl = GirlCheck(Girl)
        call Set_The_Scene
        call Shift_Focus(Girl)
        $ Girl.Loc = bg_current
                ...
                menu:
                    ...
                    if Girl.Petname in ("master", "sir"):
                            ...
                            if Girl == RogueX:
                                    ...
                                    ch_j "So could I get another fix, [Girl.Petname]? . ."
                    else:             
                            if Girl == RogueX:
        ...
        if Girl == RogueX:
                ...
                if Girl.Event[1] < 11:
                    if "forced tag" in Girl.RecentActions: 
                            ...
                            #ch_j "Maybe don't be such an asshole though."
                    elif not Girl.Forced:      
                            $ Girl.Statup("Love", 80, 3)
                            $ Girl.Statup("Obed", 50, 2)
                            $ Girl.Statup("Obed", 80, 2)
...
label Addicted_Serum: #rkelj 
        ...
        if "no serum" in Girl.RecentActions:           
                if Girl == RogueX:
                        ...
                        ch_j "You blew that one, [Girl.Petname]."
                return
