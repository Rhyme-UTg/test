...
label Jean_Daddy:       #Jean_Update   
        ...
        call Set_The_Scene
        ch_j ". . ."
        if "dating" in JeanX.Traits or JeanX in Player.Harem:
            ch_j "So we've been dating a while yeah?"  
        else:    
            ch_j "This thing we've got, pretty fun, right?" 
        if JeanX.Love > JeanX.Obed and JeanX.Love > JeanX.Inbt:
            ch_j "and you've been really kind to me. . ."
        elif JeanX.Obed > JeanX.Inbt:
            ch_j "and you've been a good influence. . ."
        else:
            ch_j "like, really fun. . ."        
        ch_j "So I've been thinking, would you want to be called. . ."
        ch_j "\"daddy?\""  
        menu:
            extend ""
            "Ok, go right ahead?":            
            ...
            "What do you mean by that?": 
                $ JeanX.FaceChange("bemused") 
                ch_j "I don't know, I've had some shitty father figures. . ."
                ch_j "I just. . ."
                if JeanX.Love > JeanX.Obed and JeanX.Love > JeanX.Inbt:
                    ch_j "I think you could do better. . ."
                elif JeanX.Obed > JeanX.Inbt:
                    ch_j "you've really been assertive. . ."
                else:
                    ch_j "wouldn't it be kinky?"      
