# Laura_SexMenu //////////////////////////////////////////////////////////////////////
label Laura_SexAct(Act = 0): #rkelj 
            ...
            "Could you put on a show for me?":
                        menu:
                            ...
                            "Maybe make out with [EmmaX.Name]?" if EmmaX.Loc == bg_current:
                                        call LesScene(LauraX)
                            "Maybe make out with [JeanX.Name]?" if JeanX.Loc == bg_current:
                                        call LesScene(LauraX)
