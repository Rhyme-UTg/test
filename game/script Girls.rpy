    ...
    class GirlClass(object):  #rkelj      
        def __init__(self,Name="no name",Love=0,Obed=0,Inbt=0,Lust=0):
                ...
                if self.Tag == "Rogue":
                        ...
                        self.Casual1 = [2,"wrists","leather pants",0,"leash choker","leather bra","leather panties",0,0,0,0]
                        self.Casual2 = [2,0,"skirt","jacket","leash choker","corset","leather panties",0,0,0,0]
...
#                ch_u(Test +" b", interact=True)
        ...
        def OutfitChange(self, OutfitTemp = 0, Spunk = 0, Undressed = 0, Changed = 1,HolderOutfit=[]): #rkelj 
        ...
        def PantiesNum(self):  #rkelj 
                    ...
                    if self.Panties == "lace panties":
                        return 2    
                    elif self.Panties == "sports panties" or self.Panties == "shorts":
                        return 8   
        ...
        def GirlLikeUp(self,Chr=0,Value=0,Like=0):  
                ...
                if "Jeaned" in self.Traits:
                        ...
                        Like = getattr(self,"LikeS"+Chr.Tag) #Like = RogueX.LikeKitty
                        if Like + Value > 1000:
                                setattr(self,"LikeS"+Chr.Tag, 1000)
                        elif Like + Value < 0:
                                setattr(self,"LikeS"+Chr.Tag, 0)
                        else:
                                setattr(self,"LikeS"+Chr.Tag, Value + Like) #RogueX.LikeKitty = RogueX.LikeKitty + Value
                        return
        ...
        def NameCheck(self, Cnt = 0): #rkelj 
...
label WardrobeEditor(Chr=0): #rkelj 
    while True:
        menu Wardrobe_Menu:      
            "View" if True:
                while True:
                ...
                while True:
                    menu:
                        ...
                        "Add towel":
                            ...
                            $ Chr.Arms = 0
                        "Toggle Pierce":
                            if JeanX.Pierce == "ring":
                                $ JeanX.Pierce = "barbell"
                            elif JeanX.Pierce == "barbell":
                                $ JeanX.Pierce = 0
                            else:
                                $ JeanX.Pierce = "ring"                            
                        "Toggle up-top":
...
label Emergency_Clothing_Reset: #rkelj 
        ...
        menu:
            ...
            "Yes":
                    ...
                    $ LauraX.Gym = [0,"wrists","leather pants",0,0,"leather bra","leather panties",0,0,0,0]
...
label AnyLine(Girl=0,Templine=". . ."): #rkelj 
...
label GirlsAngry(Girls = 0,BO=[]): #rkelj 
...
label Clothes_Schedule(Girl=0,Cnt = 0): #rkelj 
                    ...
                    "Other":
                        menu:
                            ...
                            "When teaching you should wear. . ." if  Girl == EmmaX and Cnt >= 3:
                                call Clothes_ScheduleB(EmmaX,90)
...
label Clothes_ScheduleB(Girl=0,Count = 0): #rkelj 
...
label Private_Outfit(Girl=0): #rkelj 
...
label Custom_Out(Girl=0,Custom = 3, Shame = 0, Agree = 1): #rkelj 
        ...
        if Custom == 5 and Girl.Custom2[0] == 2:
                    ...
                    $ Girl.Outfit = "custom3"   
        elif Custom == 3 and Girl.Custom1[0] == 2: #if custom 1:
                    $ Girl.Outfit = "custom1"   
        else: #no
                    $ Agree = 0
...
# Start Outfit Shame / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / /
label OutfitShame(Girl=0, Custom = 3, Check = 0, Count = 0, Tempshame = 50, Agree = 1): #rkelj 
...
#        if Girl.Chest == "tank" or Girl.Chest == "leather bra":
#            $ Count = 20
...
#            $ Count = 15
#        elif Girl.Chest == "lace bra" or Girl.Chest == "lace corset":
#            $ Count = 5
#        elif Girl.Chest:
#            $ Count = 10    
#        else:  
...
label Girl_Undress(Girl=0,Region = "ask",CountStore=0): #rkelj  
...
#//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
label Top_Off(Girl=0,Intro = 1, Line = 0, Cnt = 0): #rkelj                                                     
            ...
            "Come on, Please? [[take it all off]":                                                                      
                ...
                if Approval and ApprovalCheck(Girl, 600, "L", TabM=1):                 
                        ...
                        if Girl == RogueX:
                                ...
                                if "no topless" in JeanX.RecentActions:     
                                    ch_j "Oh, whatever."
                                else:
                                    ch_j "I guess. . ."
                        $ Girl.Uptop = 1                    
...
label Top_Off_Refused(Girl=0): #rkelj                     
...
label ToplessorNothing(Girl=0): #rkelj 
...
# Bottoms ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
label Bottoms_Off(Girl=0,Intro = 1, Line = 0, Cnt = 0): #rkelj     
        $ Girl = GirlCheck(Girl)
        call Shift_Focus(Girl)
...
label Bottoms_Off_Legs(Girl=0):  #rkelj     
        $ Girl = GirlCheck(Girl)
        call Shift_Focus(Girl)
...
label NoPantiesOn(Girl=0):  #rkelj 
...
label Bottoms_Off_Refused(Girl=0):  #rkelj    
        $ Girl = GirlCheck(Girl)        
        call Shift_Focus(Girl)
...
label Rogue_First_Topless(Silent = 0, TempLine=0): #rkelj      
...
label Rogue_First_Bottomless(Silent = 0): #rkelj     
...
label Jean_First_Topless(Silent = 0, TempLine = 0):     
    ...
    if not Silent:
        ...
        menu Jean_First_TMenu:
            ...
            if ApprovalCheck(JeanX, 800) and not JeanX.Forced:                  #if she's not forced and happy about it
...
label Display_DressScreen(Girl=Ch_Focus): #rkelj 
