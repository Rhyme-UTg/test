...
# Start Round 10 / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / 
label Round10(Options = ["none"]): #rkelj   
        ...
        if Current_Time == "Night":
                    ...
                    if "blanket" in JeanX.RecentActions:
                            $ JeanX.RecentActions.remove("blanket")
        else:
                    ...
                    if bg_current == RogueX.Home:
                            ...
                            if Current_Time == "Night" and LauraX.Loc == bg_current:               
                                if LauraX.Sleep or LauraX.SEXP >= 30:                                                         
                                        ...
                                        jump Campus_Map   
                            #end Laura's room      
                    elif bg_current == JeanX.Home:
                            if JeanX.Loc == bg_current:
                                pass    
                            else:
                                "You wait for [JeanX.Name] to return."
                            call Wait
                            if Current_Time == "Night" and JeanX.Loc == bg_current:               
                                if JeanX.Sleep or JeanX.SEXP >= 30:                                                         
                                        #It's late but she really likes you
                                        ch_j "I'm going to sleep in a bit, did you want to join me?"   
                                elif ApprovalCheck(JeanX, 1000, "LI") or ApprovalCheck(JeanX, 600, "OI"):           
                                        #It's late but she really likes you
                        ...
                        if EGirls[0].Break[0] or "angry" in EGirls[0].DailyActions:
                            ...
                            if bg_current != "bg classroom":
                                ...
                                if EGirls[0] != RogueX and bg_current != EGirls[0].Loc:
                                        ...
                                        return                                        
                                elif EGirls[0] == LauraX and bg_current == "bg player" and EGirls[0].Loc != bg_current:                                    
                                        call expression EGirls[0].Tag + "_Fuckbuddy"   
                                        return
                                elif bg_current == EGirls[0].Home or bg_current == "bg player":
                                        call expression EGirls[0].Tag + "_Fuckbuddy"
...
label AskedMeet(Girl = 0, Emotion = "bemused"): # Use AskedMeet(RogueX,"angry")
    ...
    if "asked meet" not in Girl.DailyActions:
...
label CleartheRoom(Character = 0, Passive = 0, Silent = 0, Girls=[],BO=[]): #rkelj 
...
#                    jump Misplaced
        ...
        if Character != EmmaX and EmmaX not in Girls and EmmaX.Loc == "bg teacher" and bg_current == "bg classroom":   
                # If you're in the classroom and Emma is teaching. . .
                $ Girls.append(EmmaX)
...
# Start Girls Arrive / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / /  
label Girls_Arrive(Primary = 0, Secondary = 0, GirlsNum = 0,BO=[]): #rkelj 
        ...
        if len(Options) > 2:
                ...
                while Primary in Options:          
                            $ Options.remove(Primary)
                while Secondary in Options:
...
# Start Gym Clothes / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / 
label Gym_Clothes(Mode = 0, Girl = [], GirlsNum = 0, BO=[]):  #rkelj 
        #checked each time you enter or leave the Gym 
        ...
        call ReturnToSender     # returns girls from Nearby to where they are meant to be
...
label Swap_Nearby(Girl=0): #rkelj 
...
label Locked_Door(Girl=0,Entry=0): #rkelj 
...
# Start Taboo stuff / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / /
label Taboo_Level(Taboo_Loc=1,Teach=0,BO=[]): #rkelj 
...
label CheckTaboo(Girl=0,Taboo_Check=0,Girl2=[]): #rkelj 
...
#                    if Player.Cash >= 90:
#                        "You purchase the lace corset, this will look nice on [JeanX.Name]."
...
label Display_Girl(Chr=0,Dress = 1, TrigReset = 1, DLoc = 0, YLoc=50): #rkelj 
                # If Dress, then check whether the character is underdressed when displaying her
                ...
                if Chr == RogueX:
                        ...
                        if not renpy.showing("Jean_Sprite"): 
                            show Jean_Sprite at SpriteLoc(1000,YLoc) zorder Chr.Layer:
                                    offset (0,0)
                                    anchor (0.5, 0.0)  
                                    pos (1000,YLoc)  
                        show Jean_Sprite zorder Chr.Layer: # Chr.Layer:
                                easeout .5 alpha 1
                                easeout .5 zoom 1
                                offset (0,0)
                                anchor (0.5, 0.0)  
                                easeout .5 pos (DLoc,YLoc) 
                        show Jean_Sprite: # Chr.Layer:
                                alpha 1
                                zoom 1
                                offset (0,0)
                                anchor (0.5, 0.0)  
...
label ViewShift(Girl=0):
    ...
    menu:
            "Full Body":  
                    call expression Girl.Tag + "_Pos_Reset" pass (Trigger)
            "Upper half":
                    call expression Girl.Tag + "_Breasts_Launch" pass (Trigger)
            "Middle View":
                    call expression Girl.Tag + "_Middle_Launch" pass (Trigger)
            "Lower half":
                    call expression Girl.Tag + "_Pussy_Launch" pass (Trigger)
            "Never mind":
                    pass
    return
...
label AllReset(Chr = 0,BO=[]): #rkelj   
    ...
    while BO:
            ...
            if BO[0] == JeanX:     
                if JeanX.Loc == bg_current:
                        show Jean_Sprite at SpriteLoc(JeanX.SpriteLoc,50) zorder JeanX.Layer:
                                ease .5 zoom 1 xzoom 1 yzoom 1 offset (0,0) anchor (0.5, 0.0)
                        show Jean_Sprite:
                                zoom 1 xzoom 1 yzoom 1 offset (0,0) anchor (0.5, 0.0) pos (JeanX.SpriteLoc,50)
                else:
                        hide Jean_Sprite
            $ BO.remove(BO[0])
    return
...
label Sex_Menu_Threesome(Girl=0): #rkelj 
...
# Start GirlWaitUp / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / 
label GirlWaitUp(Local=0,Check=70,D20=0,Teach=0,BOA=[],BOB=[]):  #rkelj                
...
label HaremStatup(Girl=0,Check=1000,Value=0,Greater=0,BOA=[],BOB=[]): #rkelj
...
label JumperCheck(Girls=[],BO=[]): #rkelj 
...
label Quick_Sex(Girl=Ch_Focus,Act=0): #rkelj
...
label Escalation(Girl=0): #rkelj
        ...
        if Trigger == "fondle breast" and ApprovalCheck(Girl,1050,TabM=4,Alt=[[JeanX],800]) and Girl.Lust >= 30 and Girl.SuckB:
                    ...
                    #skips through since Jean does not have these actions yet.
                    pass
...
label Sex_Dialog(Primary=Ch_Focus,Secondary=0,TempFocus=0,PrimaryLust=0,SecondaryLust=0,Line1=0,Line2=0,Line3=0,Line4=0,D20S=0):  #rkelj
...
# Start Trigger swap  / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / /  
label Trigger_Swap(Active = 0, TriggerX1 = Trigger, TriggerX3 = Trigger3, Primary = Partner): #rkelj
...
label Activity_Check(Girl=0,Girl2=0,Silent=0,Removal=1,ClothesCheck=1,Mod=0,Approval=1,Tempshame=0,TabooM=1): #rkelj
...
# Start Seen Peen / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / /
label Girl_First_Peen(Girl = 0, Silent = 0, Undress = 0, Second = 0, React = 0):  #rkelj 
        ...
        if not Silent:
            ...
            if not Girl.Forced and not React and bg_current != "bg showerroom" and not ApprovalCheck(Girl, 800) and not ApprovalCheck(Girl, 500, "I") and Girl != JeanX:
            ...
            elif not Girl.Forced and not React and Taboo > 20 and (not ApprovalCheck(Girl, 1500) or Girl.SEXP < 10) and bg_current != "bg showerroom" and Girl != JeanX:
...
label Girls_Taboo(Girl=0,Cnt= 1,Choice=0,D20=0):  #nee  Rogue_Taboo(Cnt= 1,Choice=0) #rkelj
...
# Start girls noticed / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / /
label Girls_Noticed(Girl=Primary,Other=0,Silent=0,B=0,BO=[]): #rkelj
...
# Start CloseOut  / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / /  
label CloseOut(Chr = Ch_Focus): #rkelj
...
# Start Sex_Over  / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / 
label Sex_Over(Clothes=1,Girls=0,BO=[]): #rkelj
...
# Start SkipTo  / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / /  
label SkipTo(Chr = Ch_Focus): #rkelj
